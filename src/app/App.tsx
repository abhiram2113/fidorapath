  ...
  const stars = useMemo(
    () =>
      Array.from({ length: 60 }, (_, i) => ({
        ...
        left: Math.random() * 100,
        top: Math.random() * 100,
        lo: Math.random() * 0.05 + 0.02,
        hi: Math.random() * 0.25 + 0.05,
        dur: Math.random() * 6 + 2,
        del: Math.random() * 6,
      })),
    []
    ...
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          backgroundSize:
            '200px 200px, 200px 200px, 46px 46px, 46px 46px',
        }}
      />
      ...
      <motion.div
        ...
        style={{
          ...
          bottom: '0%',
          background:
            'radial-gradient(circle, rgba(200,146,42,0.08) 0%, transparent 65%)',
        }}
        animate={{
          scale: [1, 1.3, 1],
          opacity: [0.5, 0.9, 0.5],
      ...
      <motion.div
        ...
        style={{
          ...
          background:
            'radial-gradient(circle, rgba(6,9,26,0.8) 0%, transparent 70%)',
        }}
        animate={{
          scale: [1, 1.15, 1],
        }}
      ...
      <motion.div
        ...
        style={{
          ...
          top: '20%',
          background:
            'radial-gradient(circle, rgba(232,185,74,0.06) 0%, transparent 70%)',
        }}
        animate={{
          scale: [1, 1.5, 1],
      ...
      <motion.div
        ...
        style={{
          ...
          bottom: '10%',
          background:
            'radial-gradient(circle, rgba(200,146,42,0.055) 0%, transparent 70%)',
        }}
        animate={{
          scale: [1, 1.22, 1],
      ...
      {shootingStars.map((s) => (
        <motion.div
          ...
          style={{
            ...
            height: 1.5,
            background:
              'linear-gradient(90deg, transparent, rgba(200,146,42,0.8), rgba(232,185,74,0.3), transparent)',
...
export default function App() {
  return (
    <div
      className="relative min-h-screen bg-[#06091A] text-[#F0EDD8] selection:bg-[#C8922A]/30 selection:text-[#F0EDD8]"
      style={{
